...
Public Class PACKING
    ...
    Private Sub GRIDDATABIND()
        Try
            ...
            APPCON.CNN.Open()
            Dim STRSQL As String
            STRSQL = "SELECT * FROM SCANNED WHERE ITEMCODE ='" & Trim(MCODE.Text) & "' and barcode='" & Trim(L) & "'AND TYPE ='PRODUCTION' AND BARCODE NOT IN (SELECT BARCODE FROM PACKING WHERE ITEMCODE ='" & Trim(MCODE.Text) & "' and barcode='" & Trim(L) & "')"
    ...
    Private Sub INSERTDATA()
        Try
            ...
            If APPCON.CNN.State = ConnectionState.Open Then APPCON.CNN.Close()
            APPCON.CNN.Open()
            OBJSQLCOMMAND = New SqlCommand("SELECT MAX(ID) as PKGID FROM PACKING ", APPCON.CNN)
        ...
        Try
            ...
            If Val(CMBQTY.Text) = Val(TXTCOUNTER.Text) Then
                ...
                If CMBLINE.Text = "" Then
                    ...
                    Exit Sub
                End If
                BILLNO = GENFUNCTION.AutoCodeGen("PACKING", "TRNO", "M", "", "10", "")
