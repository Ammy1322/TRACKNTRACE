...
Public Class ORDER_FEEDING
    ...
    Private Sub INSERTDATA()
        ...
        End Try
    End Sub
    Private Sub BTNSEARCH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSAVE.Click
        Try
            Dim SRNOO As String = ""
            ...
            If TXTMOB.Text = "" Then
                ...
                Exit Sub
            End If
            BILLNO = GENFUNCTION.AutoCodeGen("orderfeed", "ORDERNO", "O", "", "10", "")
